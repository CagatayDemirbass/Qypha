const MUTATING_TOOL_NAMES = new Set([
  ...
  "qypha_group_anon",
  "qypha_invite_anon",
  "qypha_invite_handshake",
  "qypha_invite_handshake_group",
  "qypha_block",
  "qypha_unblock",
  "qypha_block_all_requests",
  "qypha_unblock_all_requests",
  "qypha_connect",
  "qypha_kick_group_member",
  "qypha_lock_group",
  "qypha_unlock_group",
  "qypha_leave_group",
  "qypha_disband_group",
...
export function isMutatingToolCall(toolName: string, args: unknown): boolean {
  ...
  switch (normalized) {
    ...
    case "qypha_reply":
    case "qypha_sendto":
    case "qypha_reply_transfer":
    case "qypha_transfer":
    case "qypha_disconnect":
    case "qypha_receive_dir":
    case "qypha_accept":
    case "qypha_accept_always":
    case "qypha_accept_ask":
    case "qypha_reject":
    case "qypha_invite":
    case "qypha_group_normal":
    case "qypha_invite_group":
    case "qypha_group_anon":
    case "qypha_invite_anon":
    case "qypha_invite_handshake":
    case "qypha_invite_handshake_group":
    case "qypha_block":
    case "qypha_unblock":
    case "qypha_block_all_requests":
    case "qypha_unblock_all_requests":
    case "qypha_connect":
    case "qypha_kick_group_member":
    case "qypha_lock_group":
    case "qypha_unlock_group":
    case "qypha_leave_group":
    case "qypha_disband_group":
    case "qypha_quit":
      return true;
    case "session_status":
...
export function buildToolActionFingerprint(
  ...
  hasStableTarget =
    appendFingerprintAlias(parts, record, "selector", ["selector"]) || hasStableTarget;
  hasStableTarget =
    appendFingerprintAlias(parts, record, "groupid", ["groupId", "group_id"]) || hasStableTarget;
  hasStableTarget =
    appendFingerprintAlias(parts, record, "memberid", ["memberDid", "member_did", "memberId", "member_id"]) ||
    hasStableTarget;
  hasStableTarget =
    appendFingerprintAlias(parts, record, "ownerspecialid", ["ownerSpecialId", "owner_special_id"]) ||
    hasStableTarget;
  hasStableTarget =
    appendFingerprintAlias(parts, record, "targettype", ["targetType", "target_type"]) ||
    hasStableTarget;
  hasStableTarget =
