...
function resolveBundledDirFromPackageRoot(
  ...
  // Embedded forks can ship source extensions without a compiled dist/extensions tree.
  // In that layout, source extensions are the only authoritative bundled plugins.
  if (
    fs.existsSync(sourceExtensionsDir) &&
